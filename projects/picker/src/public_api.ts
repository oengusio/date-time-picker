...
export { OwlTemporalDateTimeModule } from './lib/date-time/adapter/temporal-date-time.module';
...
export { TemporalDateTimeAdapter } from './lib/date-time/adapter/temporal-date-time-adapter.class';
